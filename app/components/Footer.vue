  ...
  <footer class="bg-white py-12 border-t">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mt-12 flex flex-wrap justify-center items-center gap-8">
        <img
          :src="urlFor(footer[0].images[0])"
          alt="WARD"
          class="h-[60px] w-auto"
          v-if="footer[0] && footer[0].images[0]"
        />
        <img
          :src="urlFor(footer[0].images[1])"
          alt="AFID Certification"
          class="h-[60px] w-auto"
          v-if="footer[0] && footer[0].images[1]"
        />
        <img
          :src="urlFor(footer[0].images[2])"
          alt="Partnership Badge"
          class="h-[60px] w-auto"
          v-if="footer[0] && footer[0].images[2]"
        />
        <img
          :src="urlFor(footer[0].images[3])"
          alt="H Badge"
          class="h-[60px] w-auto"
          v-if="footer[0] && footer[0].images[3]"
        />
        <img
          :src="urlFor(footer[0].images[4])"
          alt="CCBP Badge"
          class="h-[60px] w-auto"
          v-if="footer[0] && footer[0].images[4]"
        />
        <img
          :src="urlFor(footer[0].images[5])"
          alt="SHRM Badge"
          class="h-[60px] w-auto"
          v-if="footer[0] && footer[0].images[5]"
        />
      </div>
    </div>
  </footer>
