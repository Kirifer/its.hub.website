        ...
        <div class="mt-5 sm:mt-6 p-8">
          ...
          >
            <ul class="space-y-4 list-disc list-inside">
              ...
              <li>
                Proven experience as a Senior Finance Officer or similar role.
              </li>
              <li>
              ...
              <li>
                Proficient in using accounting software systems and advanced
                knowledge of Microsoft Excel.
              </li>
              <li>Excellent attention to detail and accuracy.</li>
              <li>
                Ability to effectively prioritize and meet deadlines in a
